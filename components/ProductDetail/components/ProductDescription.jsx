...
const ProductDescription = () => {
  const details = {
    ...
    giftOptions:
      `Choose gift options when you check out. Some items may not be eligible for certain gift wrap options.`,
    detailsAndCare: {
      description:
        `A soft and stretchy cotton blend means easy comfort in modern jogger pants with versatile appeal.`,
      details: [
